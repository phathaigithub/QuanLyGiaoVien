...
namespace Project_DBManager.DAO
{
    ...
    {
        private readonly string connectString = "Server=cnpm12.cl842wcy40x2.ap-southeast-2.rds.amazonaws.com,1433;Database=QUANLYLICHDAY;User Id=admin;Password=congnghephanmem;";
